    ...
    public class UserService {
        ...
        @Transactional
        public void updateUser(Long id, User updatedUser, List<Long> roleIds, String email, String username) {
            ...
            // Обновляем роли, если переданы roleIds
            if (roleIds != null && !roleIds.isEmpty()) {
                // Получаем новые роли из базы
